...
class AdminAdvertisementController extends Controller
{
    public function home_ad_show()
    {
        ...
        return view('admin.ads.ads_home', compact('home_ad_data'));
    }
    ...
    public function top_ad_show()
    {
        ...
        return view('admin.ads.ads_top', compact('top_ad_data'));
    }
    ...
    public function sidebar_ad_show()
    {
        ...
        return view('admin.ads.ads_sidebar_view', compact('sidebar_ad_data'));
    }

    public function sidebar_ad_create()
    {
        return view('admin.ads.ads_sidebar_create');
    }
    ...
    public function sidebar_ad_store(Request $request)
    {
        $request->validate([
            ...
            'sidebar_ad' => 'Select a photo for ads',
            'sidebar_ad.image' => 'Photo must be an image',
            'sidebar_ad.mimes' => 'Correct format is jpg, jpeg, png, gif',
        ]);
    ...
    public function sidebar_ad_edit($id)
    {
        ...
        return view('admin.ads.ads_sidebar_edit', compact('sidebar_ad_data'));
    }
