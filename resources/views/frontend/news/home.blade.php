@extends('frontend.news.layouts.app')
        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="left-side">
                                        ...
                                        <h3><a href="">Haaland scores before going off injured in Dortmund win and
                                                it is very real</a></h3>
                                        <div class="date-user">
                                            <div class="user">
                                                <a href="">Paul David</a>
                                            </div>
                                        ...
                                        <p>
                                            ...
                                            est an. Cum ei doctus oporteat contentiones, vix ...
                                        </p>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-12">
                ...
                <div class="col-lg-4 col-md-6 sidebar-col">
                    @include('frontend.news.layouts.sidebar')
                </div>
            </div>
        </div>
    </div>
